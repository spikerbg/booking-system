(function (global, factory) {
    ...
    const actions = {
        ...
        post: (context, tokens, query, body) => {
            ...
            const newId = uuid$1();
            responseData[newId] = Object.assign({}, body, { id: newId });
        ...
        try {
            ...
            if (query.load) {
                ...
                props.map(prop => {
                    ...
                    console.log(`Loading related records from "${collection}" into "${propName}", joined on "id"="${idSource}"`);
        ...
        return function decorateContext(context, request) {
            ...
            function register(body) {
                if (body.hasOwnProperty(identity) === false ||
                    ...
                    const session = saveSession(result.id);
            ...
            function logout() {
                if (context.user !== undefined) {
                    const session = findSessionByUserId(context.user.id);
                    if (session !== undefined) {
                        context.protectedStorage.delete('sessions', session.id);
                    }
                } else {
            ...
            function saveSession(userId) {
                ...
                const accessToken = hash(session.id);
                session = context.protectedStorage.set('sessions', session.id, Object.assign({ accessToken }, session));
                return session;
            }
    ...
    function initPlugin$3(settings) {
        ...
        return function decorateContext(context, request) {
            ...
            const isOwner = (user, object) => {
                return user.id == object._ownerId;
            };
            context.rules = {
                get,
                isOwner
            ...
            function checkRoles(roles, data, newData) {
                if (roles.includes('Guest')) {
                    ...
                    return context.user.id == data._ownerId;
                } else {
                    return false;
                }
            }
        ...
        function getRule(action, collection, data = {}) {
            ...
            if (collectionRules !== undefined) {
                ...
                // Rules by record id 
                const recordRules = collectionRules[data.id];
    ...
    var protectedData = {
    	users: {
    		...
    		"60f0cf0b-34b0-4abd-9769-8c42f830dffc": {
                id: "60f0cf0b-34b0-4abd-9769-8c42f830dffc",
    			email: "admin@abv.bg",
    			username: "Admin",
    ...
    avgRating: "4.8",
    totalRating: "272",
    about: "Dr. Rodriguez earned her medical degree from the prestigious University of Medicine, where her passion for medicine and genuine concern for patients became evident. Throughout her career, she has continually pursued advanced training and stays abreast of the latest medical advancements, ensuring that her patients receive the best possible care.",
    photo: "https://static.vecteezy.com/system/resources/previews/002/896/807/non_2x/female-doctor-using-her-digital-tablet-free-vector.jpg",
    totalPatients: "500",
    date: "23 June, 2008",
    ...
    2: {
            ...
            about: "Dr. Rodriguez earned her medical degree from the prestigious University of Medicine, where her passion for medicine and genuine concern for patients became evident. Throughout her career, she has continually pursued advanced training and stays abreast of the latest medical advancements, ensuring that her patients receive the best possible care.",
              ...
              3: {
                ...
                avgRating: 4.6,
                totalRating: 272,
                about: "Dr. Uris Tar is a dedicated and compassionate gynecologist with a passion for women's health. With years of specialized training and expertise in gynecology, Dr. Tar is committed to providing comprehensive and personalized care to his patients. From routine check-ups to advanced reproductive health services, Dr. Tar combines medical excellence with a warm and empathetic approach. His focus on open communication ensures that every patient feels comfortable and informed throughout their healthcare journey. ",
                photo: "https://static.vecteezy.com/system/resources/previews/002/896/807/non_2x/female-doctor-using-her-digital-tablet-free-vector.jpg",
                totalPatients: 1000,
                date: "23 June, 2008",
